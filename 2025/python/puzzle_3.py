...
def puzzle_3b(filepath):
    ...
    with open(filepath) as f:
        for line in f:
            ...
            to_remove = len(digits) - NUM_LEN
            res = []

            for digit in digits:
                while len(res) > 0 and digit > res[-1] and to_remove > 0:
                    res.pop()
                    to_remove -= 1
                res.append(digit)
            ...
            joltage = int("".join(str(x) for x in res))
...
if __name__ == "__main__":
    ...
    print("Puzzle 2b - total joltage is:", puzzle_3b("2025/resources/puzzle_3.txt"))
